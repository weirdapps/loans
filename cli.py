...
partner_rate = float(input("Enter the partner's commission rate (in percentage): "))
...
print(f"Annual Rate (after deducting partner's commission): {annual_rate_guess * 100:.2f}%")
